...
export abstract class AbstractService<DTO extends BaseDto, CRITERIA extends BaseCriteria> {
    ...
    public findPaginatedByCriteria(criteria: CRITERIA): Observable<PaginatedList<DTO>> {
            return this.httpClient.post<PaginatedList<DTO>>(this.API + 'paginatedListByCriteria', criteria);
    }
    public findHistoryPaginatedByCriteria(criteria: CRITERIA): Observable<PaginatedList<DTO>> {
        return this.httpClient.post<PaginatedList<DTO>>(this.API + 'history-paginated-by-criteria', criteria);
    }

    public findHistoryById(id:number):Observable<DTO> {
        return this.httpClient.get<DTO>(this.API + 'history/id/'+id);
    }

    public findAllHistory(){
        return this.httpClient.get<Array<DTO>>(this.API + 'history-by-criteria');
    }
    public findAll() {
