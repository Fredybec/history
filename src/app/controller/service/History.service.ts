...
import {HistoryCriteria} from "../criteria/HistoryCriteria.model";

@Injectable({
  providedIn: 'root'
})
export class HistoryService extends AbstractService<HistoryDto, HistoryCriteria> {
    ...
    public constrcutDto(): HistoryDto {
        return new HistoryDto();
    }

    public constrcutCriteria(): HistoryCriteria {
