...
@Component({
  selector: 'app-achat-view-history-admin',
  templateUrl: './achat-view-history-admin.component.html'
})
export class AchatViewHistoryAdminComponent extends AbstractViewController<HistoryDto, HistoryCriteria, HistoryService> implements OnInit {
...
, private paiementAchatService: PaiementAchatService, private modePaiementService: ModePaiementService, private fournisseurService: FournisseurService, private avoirAchatService: AvoirAchatService, private achatItemService: AchatItemService, private storeService: StoreService, private produitService: ProduitService
    ){
        super(datePipe, historyService, messageService, roleService, router, stringUtilService);
    }
